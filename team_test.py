...
def create_weapon():
    ...
    return superduel.Weapon(name, power)
...
def create_ability():
    ...
    return superduel.Ability(name, power)
...
def create_hero(max_strength=100, weapons=False, armors=False, health=False):
    ...
    hero = superduel.Hero(name, power)
...
def test_armor():
    armor = superduel.Hero("The Ring", 200)
...
def test_hero_start_health():
    hero = superduel.Hero("Jodie Foster", 300)
